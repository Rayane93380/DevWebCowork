...
from .views import modifier_profil, signup, login_user, logout_user, visiteur_index2, temperature_salles2, liste_salles2, poubelles_vides2, ordi_dispo2, reserver_salle, reserver_PC, modifier_temp, activate, email_verification_sent
